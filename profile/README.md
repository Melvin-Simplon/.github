...
twenty-seven hands-on labs, grouped below by the skill they demonstrate rather than
...
| [prometheus-node-exporter-grafana](https://github.com/Melvin-Simplon/prometheus-node-exporter-grafana) | <img src="https://skillicons.dev/icons?i=docker,prometheus,grafana,linux" height="22" /> | Host metrics scraped in pull mode from node_exporter, with hardened containers and nothing exposed beyond loopback. |
